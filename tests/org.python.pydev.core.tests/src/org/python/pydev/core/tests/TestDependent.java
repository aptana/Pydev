 ...
 * values as needed...
 */
package org.python.pydev.core.tests;
...
public class TestDependent {
    ...
    static {
        try {
            ...
            if (platform != null) {
                propertiesFile = "org/python/pydev/core/tests/TestDependent." + platform + ".properties";
            ...
            if (TEST_PYSRC_LOC == null) {
                TEST_PYSRC_LOC = TEST_PYDEV_BASE_LOC + "org.python.pydev.tests/src/pysrc/";
            }
            ...
            if (TEST_PYSRC_NAVIGATOR_LOC == null) {
                TEST_PYSRC_NAVIGATOR_LOC = TEST_PYDEV_BASE_LOC + "org.python.pydev.tests/src_navigator/pysrc/";
            }
            ...
            if (TEST_PYDEV_PLUGIN_LOC == null) {
                TEST_PYDEV_PLUGIN_LOC = TEST_PYDEV_BASE_LOC + "org.python.pydev.tests/";
            }
            ...
            if (TEST_PYDEV_DEBUG_PLUGIN_LOC == null) {
                TEST_PYDEV_DEBUG_PLUGIN_LOC = TEST_PYDEV_BASE_LOC + "org.python.pydev.debug.tests/";
            }
            ...
            if (TEST_PYDEV_PARSER_PLUGIN_LOC == null) {
                TEST_PYDEV_PARSER_PLUGIN_LOC = TEST_PYDEV_BASE_LOC + "org.python.pydev.parser.tests/";
            }
